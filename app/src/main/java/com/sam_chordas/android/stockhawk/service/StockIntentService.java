...
public class StockIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getStringExtra(getString(R.string.key_tag)).equals(getString(R.string.type_add))) {
        ...
        int result = stockTaskService.onRunTask(new TaskParams(intent.getStringExtra(getString(R.string.key_tag)), args));
